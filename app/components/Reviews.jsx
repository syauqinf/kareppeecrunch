  ...
  const reviews = [
    {
      ...
      review: 'Saya suka keduanya varian hotlado dan coklat. Yang rasa hotlado enak banget, pokoknya mantul dan wajib order lagi.'
    },
    {
      id: 2,
      name: 'Sharifah Ulya',
            ...
            <StaggerItem key={review.id} className="group relative">
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100 hover:border-orange-300 h-full flex flex-col relative overflow-hidden">
                <div className="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity duration-500 ease-out">
                  <Quote className="w-8 h-8 text-orange-600" aria-hidden="true" />
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className={`w-3 h-3 ${i < review.rating ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} aria-hidden="true" />
                      ))}
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <div className="flex items-center justify-center">
                    <div className="flex items-center text-orange-500">
                      <Heart className="w-4 h-4 fill-current mr-1" aria-hidden="true" />
