        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 sm:col-span-1">
            ...
            <div className="flex gap-3 md:gap-4 mt-2">
              {/* Instagram */}
              <a className="text-gray-400 hover:text-orange-400 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center" href="https://instagram.com/kareppeecrunch" target="_blank" rel="noopener noreferrer" aria-label="Kunjungi Instagram Kareppee Crunch">
              ...
              {/* Facebook */}
              <a className="text-gray-400 hover:text-orange-400 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center" href="https://www.facebook.com/61583619765023/" target="_blank" rel="noopener noreferrer" aria-label="Kunjungi Facebook Kareppee Crunch">
              ...
              {/* TikTok */}
              <a className="text-gray-400 hover:text-orange-400 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center" href="https://tiktok.com/@kareppeecrunch" target="_blank" rel="noopener noreferrer" aria-label="Kunjungi TikTok Kareppee Crunch">
